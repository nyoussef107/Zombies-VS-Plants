...
def resizeRect(rect, width, height):
    """Returns a new rectangle with adjusted width and height while keeping the center."""
    new_rect = Rect(rect.centerx - width // 2, rect.centery - height // 2, width, height)
    return new_rect
