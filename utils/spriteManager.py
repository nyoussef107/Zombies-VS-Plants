...
class SpriteManager(object):
   ...
   class _SM(object):
      ...
      _SPRITE_SIZES = {"artorias.png": (240,320) , "orb2.png": (30, 30), "kirby.png": (16,16), "zom.png": (64,64), "yeti.png": (100,100), "plany.png":(118, 130), "dave.png": (115, 200), 
      "beam.png": (1232, 184), "beamy.png": (7000, 40), "spudow.png" : (76,66), "stdzom.png": (88,65)}
      
      # A default sprite size
      _DEFAULT_SPRITE = (32,32)
      
      # A list of images that require to be loaded with transparency
      _TRANSPARENCY = ["artorias.png","orb2.png","star.png","kirby.png","zom.png", "plany.png", "dave.png",'beam.png', 'beamy.png',"lazer.png","potatomine.png","spudow.png","yeti.png", "stdzom.png","brainy.png"]
      
      # A list of images that require to be loaded with a color key
      _COLOR_KEY = ["orb2.png","star.png","kirby.png","zom.png", "plany.png", "dave.png","beam.png", 'beamy.png',"lazer.png","spudow.png","yeti.png", "stdzom.png", "brainy.png"]
