...
class lvl4Engine(object):
    ...
    def __init__(self):
        ...
        self.plants = [Plant((r[0], c[0]), 0, 0, 0, reward=True), Laser((r[1], c[0]), 0, 0, 0), Plant((r[2], c[0]), 0, 0, 0, reward=True), Potatomine((r[3], c[0]), 0, 0, 0),
                       Plant((r[0], c[1]), 0, 0, 0, reward=True), Potatomine((r[1], c[1]), 0, 0, 0), Plant((r[2], c[1]), 0, 0, 0), Potatomine((r[3], c[1]), 0, 0, 0),
                       Plant((r[0], c[2]), 0, 0, 0, reward=True), Laser((r[1], c[2]), 0, 0, 0), Potatomine((r[2], c[2]), 0, 0, 0), Laser((r[3], c[2]), 0, 0, 0),
                       Laser((r[0], c[3]), 0, 0, 0), Plant((r[1], c[3]), 0, 0, 0), Plant((r[2], c[3]), 0, 0, 0), Laser((r[3], c[3]), 0, 0, 0)]
        ...
        self.story_text_lines = [
            "A New Enemy: Laser Bean!!",
            "Affects all the zombies on its lane",            
        ]
